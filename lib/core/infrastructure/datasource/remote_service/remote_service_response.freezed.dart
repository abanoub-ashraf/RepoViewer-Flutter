...
part of 'remote_service_response.dart';
...
/// @nodoc
class _$RemoteServiceResponseTearOff {
  const _$RemoteServiceResponseTearOff();
...
/// @nodoc
const $RemoteServiceResponse = _$RemoteServiceResponseTearOff();

/// @nodoc
mixin _$RemoteServiceResponse<T> {
  ...
  @JsonKey(ignore: true)
  $RemoteServiceResponseCopyWith<T, RemoteServiceResponse<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RemoteServiceResponseCopyWith<T, $Res> {
  factory $RemoteServiceResponseCopyWith(RemoteServiceResponse<T> value,
          $Res Function(RemoteServiceResponse<T>) then) =
      _$RemoteServiceResponseCopyWithImpl<T, $Res>;
  $Res call({int maxPage});
}

/// @nodoc
class _$RemoteServiceResponseCopyWithImpl<T, $Res>
    implements $RemoteServiceResponseCopyWith<T, $Res> {
  _$RemoteServiceResponseCopyWithImpl(this._value, this._then);

  final RemoteServiceResponse<T> _value;
  // ignore: unused_field
  final $Res Function(RemoteServiceResponse<T>) _then;
...
class __$NoConnectionCopyWithImpl<T, $Res>
    extends _$RemoteServiceResponseCopyWithImpl<T, $Res>
...
class _$_NoConnection<T> extends _NoConnection<T> {
  ...
  @override
  String toString() {
    return 'RemoteServiceResponse<$T>.noConnection(maxPage: $maxPage)';
  }
...
abstract class _NoConnection<T> extends RemoteServiceResponse<T> {
...
class _$_NotModified<T> extends _NotModified<T> {
  ...
  @override
  String toString() {
    return 'RemoteServiceResponse<$T>.notModified(maxPage: $maxPage)';
  }
...
abstract class _NotModified<T> extends RemoteServiceResponse<T> {
...
class _$_WithNewData<T> extends _WithNewData<T> {
  ...
  @override
  String toString() {
    return 'RemoteServiceResponse<$T>.withNewData(data: $data, maxPage: $maxPage)';
  }
...
abstract class _WithNewData<T> extends RemoteServiceResponse<T> {
